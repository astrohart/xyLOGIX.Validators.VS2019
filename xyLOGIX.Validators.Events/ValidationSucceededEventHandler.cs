namespace xyLOGIX.Validators.Events
{
    ...
    /// </param>
    /// <param name="e">
    /// A <see cref="T:xyLOGIX.Validators.Events.ValidationSucceededEventArgs"/> that contains the event data.
    /// </param>
    /// <remarks>
    /// This delegate merely specifies the signature of all methods that handle the ValidationSucceeded event.
    /// </remarks>
    public delegate void ValidationSucceededEventHandler(object sender,
