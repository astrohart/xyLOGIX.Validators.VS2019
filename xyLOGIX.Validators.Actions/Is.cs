...
namespace xyLOGIX.Validators.Actions
{
    ...
    public static class Is
    {
        ...
        /// </returns>
        public static bool HasValidExtension([NotLogged] string pathname)
        {
            var result = false;
            ...
            try
            {
                DebugUtils.WriteLine(
                    DebugLevel.Info,
                    "Is.HasValidExtension *** INFO: Checking whether the value of the parameter, 'pathname', is blank..."
                );
                ...
                if (string.IsNullOrWhiteSpace(pathname))
                {
                    ...
                    DebugUtils.WriteLine(
                        DebugLevel.Error,
                        "Is.HasValidExtension: *** ERROR *** The parameter, 'pathname', was either passed a null value, or it is blank. Stopping..."
                    );

                    DebugUtils.WriteLine(
                        DebugLevel.Debug,
                        $"Is.HasValidExtension: Result = {result}"
                    );
                ...
                DebugUtils.WriteLine(
                    DebugLevel.Info,
                    "Is.HasValidExtension: Checking whether the field, 'ValidProjectFilenameExtensions.Extensions', has a null reference for a value..."
                );
                ...
                if (ValidProjectFilenameExtensions.Extensions == null)
                {
                    ...
                    DebugUtils.WriteLine(
                        DebugLevel.Error,
                        "Is.HasValidExtension: *** ERROR *** The field, 'ValidProjectFilenameExtensions.Extensions', has a null reference.  Stopping..."
                    );
                ...
                DebugUtils.WriteLine(
                    DebugLevel.Info,
                    "Is.HasValidExtension: *** SUCCESS *** The field, 'ValidProjectFilenameExtensions.Extensions', has a valid object reference for its value.  Proceeding..."
                );

                DebugUtils.WriteLine(
                    DebugLevel.Info,
                    "Is.HasValidExtension *** INFO: Checking whether the array, 'ValidProjectFilenameExtensions.Extensions', has greater than zero elements..."
                );
                ...
                if (ValidProjectFilenameExtensions.Extensions.Length <= 0)
                {
                    ...
                    DebugUtils.WriteLine(
                        DebugLevel.Error,
                        "Is.HasValidExtension *** ERROR *** The array, 'ValidProjectFilenameExtensions.Extensions', has zero elements.  Stopping..."
                    );
                ...
                DebugUtils.WriteLine(
                    DebugLevel.Info,
                    $"Is.HasValidExtension *** SUCCESS *** {ValidProjectFilenameExtensions.Extensions.Length} element(s) were found in the 'ValidProjectFilenameExtensions.Extensions' array.  Proceeding..."
                );

                DebugUtils.WriteLine(
                    DebugLevel.Info,
                    "Is.HasValidExtension: Checking whether the file, whose fully-qualified pathname is specified by the parameter, 'pathname', exists..."
                );
                ...
                DebugUtils.WriteLine(
                    DebugLevel.Info,
                    "Is.HasValidExtension: Checking whether the variable, 'pathnameExtension', has a null reference for a value, or is blank..."
                );
                ...
                if (string.IsNullOrWhiteSpace(pathnameExtension))
                {
                    ...
                    DebugUtils.WriteLine(
                        DebugLevel.Error,
                        "Is.HasValidExtension: *** ERROR *** The variable, 'pathnameExtension', has a null reference or is blank.  Stopping..."
                    );
                ...
                DebugUtils.WriteLine(
                    DebugLevel.Info,
                    $"Is.HasValidExtension: *** SUCCESS *** {pathnameExtension.Length} B of data appear to be present in the variable, 'pathnameExtension'.  Proceeding..."
                );

                DebugUtils.WriteLine(
                    DebugLevel.Info,
                    "Is.HasValidExtension: Checking whether the file extension, specified by the variable, 'pathnameExtension', is in the list of supported project filename extensions..."
                );
        ...
        /// <see cref="Is.HasValidExtension(string)" /> method, except it avoids writing to
